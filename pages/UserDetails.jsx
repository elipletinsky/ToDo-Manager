...
export function UserDetails(){
    ...
    // const [userPreferences, setUserPreferences] = useState( {color: 'black', bgColor: 'white'})
    ...
    const {fullname, backgroundColor = "#ffe4c4", txtColor ,activities} = userToEdit
    if (!loaded) return <div>Loading...</div>;
    return(
    <section className="user-details">
        <section className="user-preferences">
        <form onSubmit={onSaveUser} style={{ backgroundColor: backgroundColor, color : txtColor }}>
